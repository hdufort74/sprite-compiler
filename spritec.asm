...
CODE_PTR	fdb		s00_00,s00_0N,s00_M0,s00_MN,s_0L_00,s_0L_0N,s_0L_M0,s_0L_MN,s_K0_00,s_K0_0N,s_K0_M0,s_K0_MN,s_KL_00,s_KL_0N,s_KL_M0,s_KL_MN
...
; IN  regU:src bytes
; IN  regX:destination pointer
; IN  regA:width in bytes (2..126)
; IN  regB:height (lines) in bytes (1..127)
; OUT regX:points to the end of the compiled data
; MODIFIED x,y,u,d
;=============================================================
